...
; Declaration 22 type: 3 (AST_INLINE_ASM = 18)
...
ir_entry_19:
    ...
    sub rsp, 32
    ; Load variable: fn
    mov rax, qword [rel fn]  ; From global memory
    mov rcx, rax
    call cstr
    mov rcx, rax
    add rsp, 32
...
ir_if_end_20:
    ...
    sub rsp, 32
    ; Load variable: line
    mov rax, qword [rel line]  ; From global memory
    mov rcx, rax
    call cstr
    mov rcx, rax
    add rsp, 32
...
section .data
; Global variable: fn (string, 16 bytes)
fn:
...
; Global variable: line (string, 16 bytes)
line:
