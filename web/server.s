...
; First pass: processing 231 declarations
...
; Declaration 128 type: 4 (AST_INLINE_ASM = 21)
...
; Declaration 142 type: 3 (AST_INLINE_ASM = 21)
...
; Declaration 207 type: 4 (AST_INLINE_ASM = 21)
; Declaration 208 type: 4 (AST_INLINE_ASM = 21)
; Declaration 209 type: 4 (AST_INLINE_ASM = 21)
; Declaration 210 type: 3 (AST_INLINE_ASM = 21)
...
; Declaration 218 type: 4 (AST_INLINE_ASM = 21)
...
ir_while_1197:
    ...
    mov rax, [rbp - 1264]
    test rax, rax
    jz ir_trap_bounds_1199
    jmp ir_in_bounds_1200
ir_trap_bounds_1199:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_while_end_1202:
    ...
    mov rax, [rbp - 1472]
    test rax, rax
    jz ir_trap_bounds_1219
    jmp ir_in_bounds_1220
ir_trap_bounds_1219:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_end_1225:
    ...
    mov rax, [rbp - 1728]
    test rax, rax
    jz ir_trap_bounds_1227
    jmp ir_in_bounds_1228
ir_trap_bounds_1227:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1228:
    ...
    mov rax, [rbp - 1760]
    test rax, rax
    jz ir_trap_bounds_1229
    jmp ir_in_bounds_1230
ir_trap_bounds_1229:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_end_1231:
    ...
    mov rax, [rbp - 1976]
    test rax, rax
    jz ir_errdefer_ok_1233
    jmp ir_errdefer_end_1234
ir_errdefer_ok_1233:
ir_errdefer_end_1234:
...
ir_in_bounds_1245:
    ...
    mov rax, [rbp - 1104]
    test rax, rax
    jz ir_trap_bounds_1246
    jmp ir_in_bounds_1247
ir_trap_bounds_1246:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_while_end_1289:
    ...
    mov rax, [rbp - 1648]
    test rax, rax
    jz ir_trap_bounds_1292
    jmp ir_in_bounds_1293
ir_trap_bounds_1292:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1293:
    ...
    mov rax, [rbp - 1720]
    test rax, rax
    jz ir_trap_bounds_1294
    jmp ir_in_bounds_1295
ir_trap_bounds_1294:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_while_1300:
    ...
    mov rax, [rbp - 1800]
    test rax, rax
    jz ir_trap_bounds_1302
    jmp ir_in_bounds_1303
ir_trap_bounds_1302:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_end_1324:
    ...
    mov rax, [rbp - 2216]
    test rax, rax
    jz ir_trap_bounds_1326
    jmp ir_in_bounds_1327
ir_trap_bounds_1326:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1327:
    ...
    mov rax, [rbp - 2248]
    test rax, rax
    jz ir_trap_bounds_1328
    jmp ir_in_bounds_1329
ir_trap_bounds_1328:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1329:
    ...
    mov rax, [rbp - 2320]
    test rax, rax
    jz ir_errdefer_ok_1330
    jmp ir_errdefer_end_1331
ir_errdefer_ok_1330:
ir_errdefer_end_1331:
...
ir_if_end_1333:
    ...
    mov rax, [rbp - 416]
    test rax, rax
    jz ir_trap_bounds_1335
    jmp ir_in_bounds_1336
ir_trap_bounds_1335:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_end_1341:
    ...
    mov rax, [rbp - 568]
    test rax, rax
    jz ir_trap_bounds_1347
    jmp ir_in_bounds_1348
ir_trap_bounds_1347:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1348:
    ...
    mov rax, [rbp - 632]
    test rax, rax
    jz ir_trap_bounds_1349
    jmp ir_in_bounds_1350
ir_trap_bounds_1349:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1350:
    ...
    mov rax, [rbp - 664]
    test rax, rax
    jz ir_trap_bounds_1351
    jmp ir_in_bounds_1352
ir_trap_bounds_1351:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1352:
    ...
    mov rax, [rbp - 696]
    test rax, rax
    jz ir_errdefer_ok_1353
    jmp ir_errdefer_end_1354
ir_errdefer_ok_1353:
ir_errdefer_end_1354:
...
ir_if_end_1339:
    ...
    mov rax, [rbp - 720]
    test rax, rax
    jz ir_errdefer_ok_1355
    jmp ir_errdefer_end_1356
ir_errdefer_ok_1355:
ir_errdefer_end_1356:
    jmp Lhandle_post_new_thread_exit
...
ir_if_end_1370:
    ...
    mov rax, [rbp - 2432]
    test rax, rax
    jz ir_trap_bounds_1376
    jmp ir_in_bounds_1377
ir_trap_bounds_1376:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_end_1364:
    ...
    mov rax, [rbp - 2488]
    test rax, rax
    jz ir_trap_bounds_1378
    jmp ir_in_bounds_1379
ir_trap_bounds_1378:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1379:
    ...
    mov rax, [rbp - 2520]
    test rax, rax
    jz ir_trap_bounds_1380
    jmp ir_in_bounds_1381
ir_trap_bounds_1380:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1381:
    ...
    mov rax, [rbp - 2552]
    test rax, rax
    jz ir_errdefer_ok_1382
    jmp ir_errdefer_end_1383
ir_errdefer_ok_1382:
ir_errdefer_end_1383:
...
ir_if_end_1385:
    ...
    mov rax, [rbp - 4288]
    test rax, rax
    jz ir_errdefer_ok_1393
    jmp ir_errdefer_end_1394
ir_errdefer_ok_1393:
ir_errdefer_end_1394:
    mov rax, 1
    jmp Lmain_exit
    jmp ir_if_end_1391
ir_if_next_1392:
ir_if_end_1391:
    ...
    mov rax, [rbp - 4336]
    test rax, rax
    jz ir_errdefer_ok_1397
    jmp ir_errdefer_end_1398
ir_errdefer_ok_1397:
ir_errdefer_end_1398:
    mov rax, 1
    jmp Lmain_exit
    jmp ir_if_end_1395
ir_if_next_1396:
ir_if_end_1395:
    ...
    mov rax, [rbp - 4384]
    test rax, rax
    jz ir_errdefer_ok_1401
    jmp ir_errdefer_end_1402
ir_errdefer_ok_1401:
ir_errdefer_end_1402:
    mov rax, 1
    jmp Lmain_exit
    jmp ir_if_end_1399
ir_if_next_1400:
ir_if_end_1399:
    ...
    mov rax, [rbp - 4432]
    test rax, rax
    jz ir_errdefer_ok_1405
    jmp ir_errdefer_end_1406
ir_errdefer_ok_1405:
ir_errdefer_end_1406:
    mov rax, 1
    jmp Lmain_exit
    jmp ir_if_end_1403
ir_if_next_1404:
...
ir_if_end_1407:
    ...
    mov rax, [rbp - 4544]
    test rax, rax
    jz ir_errdefer_ok_1413
    jmp ir_errdefer_end_1414
ir_errdefer_ok_1413:
ir_errdefer_end_1414:
    mov rax, 1
    jmp Lmain_exit
    jmp ir_if_end_1411
ir_if_next_1412:
...
ir_in_bounds_1416:
    ...
    mov rax, [rbp - 4592]
    test rax, rax
    jz ir_trap_bounds_1417
    jmp ir_in_bounds_1418
ir_trap_bounds_1417:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1430:
    ...
    mov rax, [rbp - 4784]
    test rax, rax
    jz ir_trap_bounds_1431
    jmp ir_in_bounds_1432
ir_trap_bounds_1431:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1434:
    ...
    mov rax, [rbp - 4840]
    test rax, rax
    jz ir_trap_bounds_1435
    jmp ir_in_bounds_1436
ir_trap_bounds_1435:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1440:
    ...
    mov rax, [rbp - 4928]
    test rax, rax
    jz ir_trap_bounds_1445
    jmp ir_in_bounds_1446
ir_trap_bounds_1445:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_end_1451:
    ...
    mov rax, [rbp - 5048]
    test rax, rax
    jz ir_trap_bounds_1453
    jmp ir_in_bounds_1454
ir_trap_bounds_1453:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_while_1469:
    ...
    mov rax, [rbp - 5200]
    test rax, rax
    jz ir_trap_bounds_1471
    jmp ir_in_bounds_1472
ir_trap_bounds_1471:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_next_1486:
    ...
    mov rax, [rbp - 5456]
    test rax, rax
    jz ir_trap_bounds_1490
    jmp ir_in_bounds_1491
ir_trap_bounds_1490:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_next_1489:
    ...
    mov rax, [rbp - 5600]
    test rax, rax
    jz ir_trap_bounds_1495
    jmp ir_in_bounds_1496
ir_trap_bounds_1495:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_next_1494:
    ...
    mov rax, [rbp - 5744]
    test rax, rax
    jz ir_trap_bounds_1500
    jmp ir_in_bounds_1501
ir_trap_bounds_1500:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_next_1499:
    ...
    mov rax, [rbp - 5888]
    test rax, rax
    jz ir_trap_bounds_1505
    jmp ir_in_bounds_1506
ir_trap_bounds_1505:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_next_1504:
    ...
    mov rax, [rbp - 6032]
    test rax, rax
    jz ir_trap_bounds_1510
    jmp ir_in_bounds_1511
ir_trap_bounds_1510:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1520:
    ...
    mov rax, [rbp - 6312]
    test rax, rax
    jz ir_trap_bounds_1523
    jmp ir_in_bounds_1524
ir_trap_bounds_1523:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_in_bounds_1526:
    ...
    mov rax, [rbp - 6408]
    test rax, rax
    jz ir_trap_bounds_1531
    jmp ir_in_bounds_1532
ir_trap_bounds_1531:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
...
ir_if_next_1528:
    ...
    mov rax, [rbp - 6504]
    test rax, rax
    jz ir_trap_bounds_1533
    jmp ir_in_bounds_1534
ir_trap_bounds_1533:
    ; IR call: puts (1 args)
    sub rsp, 32
    ; String literal (38 bytes)
    lea rax, [rel Lstr_struct545]  ; Load string struct address
    mov rcx, rax
    call puts
    add rsp, 32
    ; Integer/pointer return value in rax
...
ir_while_end_1424:
    ...
    mov rax, [rbp - 6704]
    test rax, rax
    jz ir_errdefer_ok_1535
    jmp ir_errdefer_end_1536
ir_errdefer_ok_1535:
ir_errdefer_end_1536:
    mov rax, 0
    jmp Lmain_exit
Lmain_exit:
    ; Function epilogue
